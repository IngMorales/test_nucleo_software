                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" value="<?php echo $row['credits']; ?>" id="creditos" name="creditos" onkeypress="return soloNumeros(event)" placeholder="Digite créditos del Curso" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3"></div>
                                                    </div>
